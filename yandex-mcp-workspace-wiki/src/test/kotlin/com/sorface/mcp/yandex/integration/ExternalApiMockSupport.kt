...
/**
 * Инфраструктура интеграционных тестов Wiki: WireMock для API Wiki и файл токенов.
 */
object ExternalApiMockSupport {
    ...
    init {
        wikiServer.start()
        tokenFile = Files.createTempFile("yandex-mcp-workspace-wiki-integration-tokens", ".json")
    ...
    fun registerProperties(registry: DynamicPropertyRegistry) {
        ...
        registry.add("yandex.oauth.base-url") { wikiServer.baseUrl() }
