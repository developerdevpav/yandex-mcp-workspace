...
WORKDIR /build
ARG MCP_MODULE=yandex-mcp-workspace-tracker
COPY pom.xml .
COPY yandex-mcp-core/pom.xml ./yandex-mcp-core/pom.xml
COPY yandex-mcp-workspace-tracker/pom.xml ./yandex-mcp-workspace-tracker/pom.xml
COPY yandex-mcp-workspace-wiki/pom.xml ./yandex-mcp-workspace-wiki/pom.xml
# Прогрев кэша зависимостей: офлайн-резолв до копирования исходников.
RUN mvn -q -B -DskipTests dependency:go-offline
COPY yandex-mcp-core/src ./yandex-mcp-core/src
COPY yandex-mcp-workspace-tracker/src ./yandex-mcp-workspace-tracker/src
COPY yandex-mcp-workspace-wiki/src ./yandex-mcp-workspace-wiki/src
...
LABEL org.opencontainers.image.title="yandex-mcp-workspace" \
      org.opencontainers.image.description="Independent MCP server for Yandex Tracker or Yandex Wiki" \
      org.opencontainers.image.source="https://github.com/developerdevpav/yandex-mcp-workspace" \
