...
/**
 * Инфраструктура интеграционных тестов Tracker: WireMock для API Tracker и файл токенов.
 */
object ExternalApiMockSupport {
    ...
    init {
        trackerServer.start()
        tokenFile = Files.createTempFile("yandex-mcp-workspace-tracker-integration-tokens", ".json")
